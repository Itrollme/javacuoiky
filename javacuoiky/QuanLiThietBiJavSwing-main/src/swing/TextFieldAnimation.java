...
public class TextFieldAnimation extends JTextField {
    ...
    private Color animationColor = new Color(3, 175, 255); // set màu icon right
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, new Color(255, 255, 255), width, 0, animationColor); // animation tròn right
        g2.setPaint(gra);
        g2.fillOval(width - height + 3, marginButton, buttonSize, buttonSize);
        //  tạo animation khi click vao button
        if (location > -1) {
